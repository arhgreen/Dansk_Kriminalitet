...
library(ggraph) #plot interactivity
library(plotly)
```
...
anmälda_åtalade_region %>% 
  ...
  labs(title = "Antal anmälningar och åtal om sexualbrott",
       subtitle = "mellan 2015 och 2024",
       x = "",
       y = "Antal",
       fill = "",
...
anmälda_åtalade_region %>% 
  ...
  scale_x_discrete(labels = c(2015, 2016, 2017, 2018, 2019,
                              2020, 2021, 2022, 2023, 2024)) +
  labs(title = "Antal anmälningar och åtal om sexualbrott mot barn under 15 år",
       x = "",
       y = "Antal",
       fill = "",
       caption = "Källa: Danmarks Statistik") +
